...
Goal:
-----
To provide easy-to-use interface for RTL developers, testers with UVM enabled testbench
...
How to use it?
----------------
Simply compile the package file vw_go2uvm_pkg.sv and derive your test from go2uvm_base_test
