...
sub vw_dvc_g2u_test {
  ...
  print $vw_sv_test_f "    `g2u_display (log_id, \"Start of reset\", UVM_MEDIUM)\n";
  print $vw_sv_test_f "    `g2u_display (log_id, \"Fill in your reset logic here \", UVM_MEDIUM)\n";
  ...
  print $vw_sv_test_f "    `g2u_display (log_id, \"End of reset\", UVM_MEDIUM)\n";
  ...
  print $vw_sv_test_f "    `g2u_display (log_id, \"Start of main\", UVM_MEDIUM)\n";
  ...
  print $vw_sv_test_f "    // repeat (5) @ (this.vif.cb);\n";
  print $vw_sv_test_f "    `g2u_display (log_id, \"End of main\", UVM_MEDIUM)\n";
