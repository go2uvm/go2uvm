...
package i2c_spec_pkg_uvm;
   ...
   endclass
    ...
    //----------------------------------------------------------------------
    // Class :i2c_spec_reg_block

    //----------------------------------------------------------------------

   class i2c_spec_reg_block extends uvm_reg_block;
      `uvm_object_utils(i2c_spec_reg_block)
      ...
      uvm_reg_map i2c_spec_reg_block_map;


      // Function: new
      //
      function new(string name = "i2c_spec_reg_block");
      ...
      virtual function void build();
         ...
         i2c_spec_reg_block_map = create_map("i2c_spec_reg_block_map",'h0,4,UVM_LITTLE_ENDIAN);
         default_map =i2c_spec_reg_block_map;
         i2c_spec_reg_block_map.add_reg(i2c_spec_PRERlo,'h0,"RW");
         i2c_spec_reg_block_map.add_reg(i2c_spec_PRERhi,'h4,"RW");
         i2c_spec_reg_block_map.add_reg(i2c_spec_CTR,'h8,"RW");
         i2c_spec_reg_block_map.add_reg(i2c_spec_TXR,'hC,"WO");
         i2c_spec_reg_block_map.add_reg(i2c_spec_RXR,'h10,"RO");
         i2c_spec_reg_block_map.add_reg(i2c_spec_CR,'h14,"WO");
         i2c_spec_reg_block_map.add_reg(i2c_spec_SR,'h18,"RO");
